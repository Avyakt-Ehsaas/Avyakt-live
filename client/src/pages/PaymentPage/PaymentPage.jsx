      ...
      <div className="mx-auto grid max-w-[1100px] grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-[28px] bg-white p-8 shadow-[0_18px_45px_rgba(85,112,73,0.12)]">
          ...
          <div className="rounded-[22px] border border-[#E8EEE2] bg-white p-6 shadow-sm">
            <div className="mb-4 flex items-start justify-between">
              <div>
                ...
                <p className="paragraph-secondary text-left font-dm text-gray">
                  Monthly Membership
                </p>
              </div>

              <div className="flex h-20 w-20 items-center justify-center rounded-full bg-[#F1F8EA] text-[#6FA35F]">
                <Leaf size={42} />
              </div>
            </div>

            <div className="mt-6 space-y-4 border-t border-[#EEF1EA] pt-5">
              <SummaryRow label="Plan" value="Practitioner" />
              <SummaryRow label="Duration" value="Monthly" />
              <SummaryRow label="Price" value="₹499" />
            </div>
            ...
            <div className="mt-6 flex items-center justify-between border-t border-dashed border-[#DDE6D5] pt-5">
              ...
              <span className="font-med card-title text-greenbase">₹499</span>
            </div>
          </div>
          ...
          <div className="mt-5 flex items-center gap-4 rounded-[18px] bg-[#F8FBF5] p-4">
            ...
            <div>
              <h4 className="font-med text-greenbase font-dm text-left text-sm font-dm mb-1">
          ...
          className="mt-4 flex w-full items-center justify-center gap-2 rounded-full bg-[#5F974E] py-4 font-dm pargaraph-secondary text-white shadow-lg shadow-[#5F974E]/25 transition hover:bg-[#4F843F]">
            <Lock size={18} />
