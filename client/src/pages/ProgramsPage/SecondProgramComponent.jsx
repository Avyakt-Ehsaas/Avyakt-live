...
const SecondProgramComponent = ({data,index}) => {
//   if(!data){
//     return (
//       <SkeletonLoader />
//     );
  ...
  return (
    ...
    <section className="relative bg-white py-24 px-6 md:px-12 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
          ...
          {/* Background Number */}
      <h1 className="absolute -top-36 right-2 font-season text-[220px] font-med text-[#C2E0BA99] -z-10">
        {index}
      </h1>
        ...
        <div className="pt-12">
          ...
          {/* Card */}
          <div className="bg-[#C2E0BA33] p-6 rounded-xl mt-6">
...
export default SecondProgramComponent;