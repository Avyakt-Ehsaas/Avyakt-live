    ...
    return (
        ...
        <div className="absolute inset-x-0 top-0 h-[75%] bg-gradient-to-b from-white/80 to-transparent pointer-events-none" />
            ...
            <div className="relative z-10 max-w-3xl px-6">
                <h1 className="text-4xl md:text-6xl font-season-medium font-semibold leading-tight text-primary">
                    Meditation, made simple <br />
                    enough for every day.
                </h1>

                <p className="mt-4 text-[20px] font-dm font-medium text-primary ">
