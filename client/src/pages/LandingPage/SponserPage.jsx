  ...
  return (
    <div className="w-full pt-24 pb-4 md:pb-18 bg-white min-h-screen mb-4 md:mb-10">
      <div className="max-w-[1280px] h-auto  mx-auto px-4 md:px-6 lg:px-8 xl:px-12 2xl:px-24">
        ...
        {/* Tabs */}
        <div className="flex gap-12 justify-center rounded-xl px-6 py-2 w-fit mx-auto relative text-[18px] flex-wrap">
          {[
            ...
            <button
              ...
              className={`relative cursor-pointer font-medium font-dm text-primary tracking-wide pb-2 flex items-center justify-center ${activeTab === tab.id ? "text-greenbase" : ""
                }`}
            >
              ...
              {/* Desktop → Label */}
              <span className=" md:block text-[18px]">
                {tab.label}
              </span>
        ...
        <div className="sponsor-page max-w-7xl pt-12">
          ...
          <p className="font-dm text-center paragraph-body leading-[24px] md:leading-[30px] tracking-[0%] mt-2">
